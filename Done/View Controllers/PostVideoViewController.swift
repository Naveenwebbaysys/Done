...
//    let addLinks1 = [String]()
    ...
    override func viewDidLoad() {
        ...
        if isFromEdit == true {
            ...
            let arrTagPeoples = self.reelsModelArray[index].tagPeoples ?? [TagPeople]()
            if arrTagPeoples.isEmpty{
                self.btnDoneApproved.setTitle("APPROVE", for: .normal)
                self.btnDoneApproved.isUserInteractionEnabled = true
            }else{
                if (arrTagPeoples[0].status ?? "") == "approved"{
...
//        print(arrData.count)
    ...
    @IBAction func btnDoneApprovedAction(_ sender: UIButton) {
        ...
        if !arrTag.isEmpty{
            ...
            //"https://d1g0ba8hbbwly8.cloudfront.net/02904F53-3A22-4D34-A39D-5F23CD2661CF-12160-000000FD0C6E6362.mp4,https://d1g0ba8hbbwly8.cloudfront.net/0B824366-6B6B-4B2E-A0BC-0763E7466CDA-13145-00000120299049D7.jpeg"//
            proofVC.employeeName = arrTag[0].employeename ?? ""
